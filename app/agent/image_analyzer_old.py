...
def create_prompt() -> str:
    return """
        ### Task: Analyze technical drawing of an aluminum-frame assembly, return **only JSON**, strictly this schema:
        {
            "panels": [
            {
...
def main():
    ...
    # image = Path("outputs/panel_analyze_pipeline/Block 0/00_origin.png")
